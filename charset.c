 ...
 *
 * $Id: charset.c,v 1.2 1997/11/07 23:45:49 rob Exp $
 */
...
/*
 * NAME:	charset->latin1()
 * DESCRIPTION:	return a Latin-1 (ISO8859-1) string for MacOS Standard Roman
 */
char *cs_latin1(char *mstr, int *lenptr)
{
  int ilen, olen, i;
  char *latin1, *ptr, *subst;
  unsigned char ch;
  UCS2 unicode;
 ...
 * DESCRIPTION:	return a MacOS Standard Roman string for Latin-1 (ISO8859-1)
 */
char *cs_macroman(char *lstr, int *lenptr)
{
  int ilen, olen, i;
  char *macroman, *ptr, *subst;
