 ...
 *
 * $Id: record.h,v 1.7 1997/09/25 00:36:50 rob Exp $
 */

void r_packcatkey(const CatKeyRec *, byte *, int *);
void r_unpackcatkey(const byte *, CatKeyRec *);

void r_packextkey(const ExtKeyRec *, byte *, int *);
...
void r_packcatdata(const CatDataRec *, byte *, int *);
void r_unpackcatdata(const byte *, CatDataRec *);

void r_packextdata(const ExtDataRec *, byte *, int *);
...
void r_packcatrec(const CatKeyRec *, const CatDataRec *, byte *, int *);
void r_packextrec(const ExtKeyRec *, const ExtDataRec *, byte *, int *);
