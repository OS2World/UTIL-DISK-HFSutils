 ...
 *
 * $Id: record.c,v 1.13 1997/11/03 23:01:28 rob Exp $
 */
 ...
 */
void r_makecatkey(CatKeyRec *key, long parid, const char *name)
{
  int len;
 ...
 */
void r_unpackdirent(long parid, const char *name,
